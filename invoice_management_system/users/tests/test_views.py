...
from invoice_management_system.users.models import User
from invoice_management_system.users.tests.factories import UserFactory
from invoice_management_system.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
